...
<div>
    <ProjectCard skills={[{title:"React js",icon:<FaReact className=' text-blue-700'/>}]} image={"/jpeg.jpeg"}  details={["AI-powered code analysis platform with debugging insights.","- Weather updates for 200,000+ cities."]} title={"CodeInsight AI"}/>
