...
import { ScrollTrigger } from 'gsap/all' // أو gsap/ScrollTrigger
...
const shadowRef=useRef()
  ...
  useGSAP(() => {
    ...
    scrollTrigger: {
      ...
      start: 'bottom bottom',
      end: isMobile ? '+=150' : '+=500', // ✅ الفرق هنا    },
  }})
  ...
  tl.to(boomRef.current, {
    ...
    { y: -800,x:-50,duration:1.5,ease:"back.out",rotate:360,duration:7},
  )
  tl.to(".counter", {
    opacity:0.2,
      duration: 1,
...
gsap.fromTo(resumeRef.current,{
  ...
  return (
    <div className='  flex flex-col  items-center gap-y-5'>
      <div className=' relative overflow-hidden lg:mt-[150px]  mt-[50px] border-[0.5px] text-[11px] lg:text-[14px] rounded-2xl border-gray-600 px-3 py-2 hover-text'>Actively Seeking Job Opportunities
...
<h1 className=' mt-10 font-bold lg:text-6xl text-3xl text-center hover-text'>Crafting Beautiful & <br /> Functional Web Experiences</h1>
<p className=' text-center text-[13px] lg:text-[20px] w-[75%] font-normal hover-text '>Hey, I'm Ahmed Anwar, a Full Stack Developer passionate about building performant, user-friendly, and scalable applications.</p>

<div className='flex items-center gap-6'>
  {/* Button 1: Waving Hand */}
  <button
...
<img ref={boomRef} className=' fixed boomRef -bottom-6  z-40 md:w-[20%] w-[60%]' src="/pngwing.com.png" alt="" />
<img ref={ bommRef} className=' fixed  lg:-bottom-[950px] -bottom-[500px] left-[60%]  md:-bottom-[900px]  z-40 md:w-[20%] w-[60%] rotate-180 rotate-z-180' src="/pngwing.com.png" alt="" />
<img ref={pinRef} className='z-40 fixed -bottom-[500px] max-md:-bottom-[500px] left-[20%] md:w-[10%] w-[30%]' src="/pin.png" alt="" />
...
<div className='fixed inset-0 flex justify-center items-center z-10 bg-transparent pointer-events-none'>    
      ...
      <div
  className="fixed  flex justify-center items-center  top-0 left-0 w-full h-full bg-white opacity-0 z-50 pointer-events-none"
  id="flash"
>
...
{/* <img ref={spoonRef}className='z-40 fixed -bottom-[550px] left-[80%] md:w-[30%] w-[60%]' src="/spoon.png" alt="" /> */}
